...
namespace AnkaX.DataAccess.Migrations
{
    ...
    [Migration("20231204134916_addShoppingCartToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnkaX.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AnkaX.Models.ShoppingCart", b =>
                {
                    b.HasOne("AnkaX.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnkaX.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("AnkaX.Models.ApplicationUser", b =>
                {
                    b.HasOne("AnkaX.Models.ViewModels.Company", "Company")
                        .WithMany()
